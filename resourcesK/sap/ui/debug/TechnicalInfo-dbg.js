...
sap.ui.define(['jquery.sap.global', 'sap/ui/core/Core', 'sap/ui/core/Popup', 'jquery.sap.strings'],
	...
	"use strict";
		...
		var TechnicalInfo = {
			...
			_renderModules : function(html, iLimit) {
				...
				var modnames=[]; jQuery.each(modules, function(sName,oModule) { if ( oModule.state > 0 ) { modnames.push(sName); }}); modnames.sort();
			...
			onOptimizeModuleSet : function(e) {
				...
				var modnames=[]; jQuery.each(this._ojQSData.modules, function(sName,oModule) { if ( oModule.state >= 0 ) { modnames.push(sName); }}); modnames.sort();
