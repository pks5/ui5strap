...
sap.m.MultiInputRenderer.openInputTag=function(r,c){r.write("<div class=\"sapMMultiInputBorder\">");r.write("<div class=\"sapMMultiInputScrollContainer\">");sap.m.MultiInputRenderer._renderTokens(r,c);sap.m.MultiInputRenderer._renderInput(r,c)};
...
sap.m.MultiInputRenderer.closeInputTag=function(r,c){sap.m.InputRenderer.closeInputTag.call(this,r,c);r.write("</div>");r.write("</div>");r.write("</div>");r.write("<div class=\"sapMMultiInputShadowDiv\"/>")};
