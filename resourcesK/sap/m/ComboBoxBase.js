...
sap.m.ComboBoxBase.prototype._getParentPopup=function(){var c=this.$();return(c&&c.closest("[data-sap-ui-popup]"))||null};
sap.m.ComboBoxBase.prototype._addFocusableParentPopup=function(d){sap.m.ComboBoxBase._publishEventToPopup({action:"add",child:this.getAggregation("picker"),parent:d})};
sap.m.ComboBoxBase.prototype._removeFocusableParentPopup=function(d){sap.m.ComboBoxBase._publishEventToPopup({action:"remove",child:this.getAggregation("picker"),parent:d})};
sap.m.ComboBoxBase._publishEventToPopup=function(o){var p,e;if(!o.parent||!o.child){return}p=o.parent.attr("data-sap-ui-popup");e="sap.ui.core.Popup."+o.action+"FocusableContent"+"-"+p;sap.ui.getCore().getEventBus().publish("sap.ui",e,{id:o.child.getId()})};
...
sap.m.ComboBoxBase.prototype._fillList=function(i){var s=this.getSelectedItem();i.forEach(function(I){var l=this._mapItemToListItem(I);this.getList().addAggregation("items",l,true);if(I===s){this.getList().setSelectedItem(l,true)}},this)};
sap.m.ComboBoxBase.prototype._clearList=function(){if(this.getList()){this.getList().destroyAggregation("items",true)}};
sap.m.ComboBoxBase.prototype.init=function(){sap.m.InputBase.prototype.init.apply(this,arguments);this.setPickerType("Popover");this._createList()};
sap.m.ComboBoxBase.prototype.exit=function(){sap.m.InputBase.prototype.exit.apply(this,arguments);this._removeFocusableParentPopup(this._getParentPopup());if(this.getList()){this.getList().destroy();this._oList=null}};
sap.m.ComboBoxBase.prototype.ontouchstart=function(e){if(this.getEnabled()&&this.getEditable()&&this.isOpenArea(e.target)){e.setMarked();this.addStyleClass(sap.m.ComboBoxBaseRenderer.CSS_CLASS+"Pressed")}};
sap.m.ComboBoxBase.prototype.ontouchend=function(e){if(this.getEnabled()&&this.getEditable()&&(!this.isOpen()||!this.hasContent())&&this.isOpenArea(e.target)){e.setMarked();this.removeStyleClass(sap.m.ComboBoxBaseRenderer.CSS_CLASS+"Pressed")}};
sap.m.ComboBoxBase.prototype.ontap=function(e){var C=sap.m.ComboBoxBaseRenderer.CSS_CLASS;if(!this.getEnabled()||!this.getEditable()){return}e.setMarked();if(this.isOpenArea(e.target)){this.selectText(0,this.getValue().length);if(this.isOpen()){this.close();this.removeStyleClass(C+"Pressed");return}if(this.hasContent()){this.open()}}if(this.isOpen()){this.addStyleClass(C+"Pressed")}};
...
sap.m.ComboBoxBase.prototype.getVisibleItems=function(){return this.getItems().filter(function(i){return i.data(sap.m.ComboBoxBaseRenderer.CSS_CLASS+"ItemVisible")})};
...
sap.m.ComboBoxBase.prototype.clearFilter=function(){var C=sap.m.ComboBoxBaseRenderer.CSS_CLASS;this.getItems().forEach(function(i){var l=i.data(C+"ListItem");i.data(C+"ItemVisible",true);l.setVisible(true)})};
...
sap.m.ComboBoxBase.prototype.addItem=function(i){this.addAggregation("items",i);i.data(sap.m.ComboBoxBaseRenderer.CSS_CLASS+"ItemVisible",true);if(this.getList()){this.getList().addItem(this._mapItemToListItem(i))}return this};
sap.m.ComboBoxBase.prototype.insertItem=function(i,I){this.insertAggregation("items",i,I);i.data(sap.m.ComboBoxBaseRenderer.CSS_CLASS+"ItemVisible",true);if(this.getList()){this.getList().insertItem(this._mapItemToListItem(i),I)}return this};
