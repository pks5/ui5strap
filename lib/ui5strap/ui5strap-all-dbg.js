...
(function(){
	...
	ui5strap.AppComponent.prototype.init = function(){
...
(function(){
	...
	*/
	AppProto.load = function(callback){
		...
		//Components
		var comps = this.config.data.components;
	...
	*/ 
	...
	AppProto.registerComponent = function(compConfig){
		...
		//console.log('Registered', compId, compModule);
		jQuery.sap.require(compModule);

				
		this[methodName] = function(){
			if(!_this.components[compId]){ 
				var ComponentConstructor = jQuery.sap.getObject(compModule);
					comp = new ComponentConstructor(_this, compConfig);
				
				_this.components[compId] = comp;
