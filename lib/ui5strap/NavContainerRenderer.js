...
(function(){
	...
	*/
	NavContainerRenderer.startRender = function(rm, oControl) {
			var navContainerClassName = "navcontainer-" + oControl.getName(),
				variation = oControl.getVariation();

		 	rm.write("<div");
		    rm.writeControlData(oControl);
		    rm.addClass("navcontainer " + navContainerClassName);
		    if('' !== variation){
		    	rm.addClass(navContainerClassName + '-' + variation);
		    }
		    rm.writeClasses();
		    rm.write(">");
	};
