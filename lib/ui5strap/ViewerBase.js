...
(function(){
	...
	ViewerBaseProto.setLoaderVisible = function(visible, callback){
		ui5strap.Layer.setVisible('ui5strap-loader', visible, callback);
	};

	ViewerBaseProto.setSplashVisible = function(visible, callback){
