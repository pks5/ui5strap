...
(function(){
	...
	* @public
	*/
	AppBaseProto.showOverlay = function(viewDataOrControl, callback){
		var _this = this,
			overlayControl = this.overlayControl;
		
		ui5strap.Layer.setVisible(this.overlayId, true, function(){
			var viewConfig = _this.config.getViewConfig(viewDataOrControl); 
			overlayControl.toPage(_this.createView(viewConfig), "content", 'transition-slide', callback);
		});
	};
