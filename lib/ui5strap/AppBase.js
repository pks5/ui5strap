...
(function(){
	...
	*/
	...
	AppBaseProto.show = function(){
		jQuery.sap.log.debug('[APP] SHOW');
	...
	AppBaseProto.shown = function(){
		jQuery.sap.log.debug('[APP] SHOWN');
	...
	*/
	AppBaseProto.getDomId = function(){
	...
	*/
	AppBaseProto.loaderVisible = false;
	AppBaseProto.$loader = jQuery('#ui5strap-loader');

	AppBaseProto.setLoaderVisible = function(visible, callback, option){
	...
	* TODO move to library
	*/
	AppBaseProto.splashVisible = false;
	AppBaseProto.$splash = jQuery('#ui5strap-splash');

	AppBaseProto.setSplashVisible = function(visible, callback, option){
