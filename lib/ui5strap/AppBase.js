...
(function(){
	...
	sap.ui.base.Object.extend('ui5strap.AppBase', {
		"constructor" : function(config, viewer){
			...
			* Loader
			*/
			this.setLoaderVisible = function(visible, callback, option){
				viewer.setLayerVisible('loader', visible, callback, option);
			};

			/*
			* Splash Screen
			*/
			this.setSplashVisible = function(visible, callback, option){
				viewer.setLayerVisible('splash', visible, callback, option);
			};
		}
	});
