	...
	*/
	...
	AppBaseProto.show = function(callback){
		...
		if(!this.hasFirstShow){
			jQuery.sap.log.debug('[APP] FIRST SHOW');
			...
			if(this.getFrame && this.getFrame()){
				var _this = this;
				this.getFrame().showInitialContent(callback);
			}
			else{
				callback && callback;
			}
	...
	AppBaseProto.shown = function(){
		...
		if(!this.hasFirstShown){
			jQuery.sap.log.debug('[APP] FIRST SHOWN');
