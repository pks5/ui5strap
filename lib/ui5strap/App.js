...
(function(){
	...
	*/
	...
	AppProto.show = function(){
		
		this.isVisible = true;
		this.onShow(new sap.ui.base.Event("ui5strap.app.show", _this, {}));

		if(!this.hasFirstShow){
			this.hasFirstShow = true;
			this.onFirstShow(new sap.ui.base.Event("ui5strap.app.firstShow", _this, {}));
