...
(function(){
	...
	* @Private
	*/
	var _incAnonymousPageId = function(_this, aggregationName){
		if(!(aggregationName in _this._anonymousPages)){
			_this._anonymousPages[aggregationName] = 0;
		}
		
		_this._anonymousPages[aggregationName]++;
	};

	/*
	* @Private
	*/
	var _pageDomId = function(_this, aggregationName, aggregationContent){
	...
	*/
	var _placePage = function(_this, target, page, isPrepared){
			...
			_incAnonymousPageId(_this, target);
			newPage.id = _pageDomId(_this, target, page);
	...
	*/
	NavContainerBaseProto.renderAggregation = function (rm, aggregationName) {
			...
			_incAnonymousPageId(this, aggregationName);

			rm.write('<div class="navcontainer-page navcontainer-page-next navcontainer-page-prerendered navcontainer-page-hidden" id="' + _pageDomId(this, aggregationName, content) + '">');
	...
	*/
	NavContainerBaseProto.toPage = function(page, target, transitionName, callback){
		...
		var $currentPage = jQuery('#' + _pageDomId(this, target, currentPage));
