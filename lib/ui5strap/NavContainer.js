...
(function(){
	...
	*/
	var _prepareTransition = function(pageChange){
		jQuery.sap.log.debug('Prepare transition: ' + pageChange.changeName);
	...
	*/
	var _executeTransition = function(_this, pageChange, transList){
		jQuery.sap.log.debug('Execute transition: ' + pageChange.changeName);
	...
	*/
	var _pageChange = function(_this, pageChange){
		jQuery.sap.log.debug('Single page change: ' + pageChange.changeName);
