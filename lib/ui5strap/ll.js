...
function libertyLite(_appBase){
	...
	_initConfig(function _initConfigSuccess(_configData){
		...
		var _setLayerVisible = function(_this, statusVarName, $layer, visible, callback){
		...
		LibertyAppProto.setLoaderVisible = function(visible, callback){
			_setLayerVisible(this, 'loaderVisible', this.$loader, visible, callback);
		};

		LibertyAppProto.splashVisible = false;
		LibertyAppProto.$splash = jQuery('#ui5strap-splash');

		LibertyAppProto.setSplashVisible = function(visible, callback){
			_setLayerVisible(this, 'splashVisible', this.$splash, visible, callback);
		};
