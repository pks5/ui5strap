...
(function ui5strapActionContext(){
	...
	*/
	ActionContextProto._setId = function(actionGroupId){
		this[ActionContext.ACTION_PREFIX + 'id'] = actionGroupId;
	};	
	...
	*/
	ActionContextProto._getId = function(actionGroupId){
		return this[ActionContext.ACTION_PREFIX + 'id'];
	};	
	...
	*/
	ActionContextProto._fetch = function(parameterKey){
			...
			var selector = this._getParameter(parameterKey + '.' + ActionContext.ACTION_PREFIX + 'selector');
			...
			var actionContext = this._getParameter(parameterKey + '.' + ActionContext.ACTION_PREFIX + 'context');
