...
(function(){
	...
	sap.ui.core.Control.extend("ui5strap.Button", {
		metadata : {
			...
			properties : { 
				...
				insertContent : {
					type:"ui5strap.Insert",
					defaultValue : ui5strap.Insert.After
				},
				navbarAlign : {
	...
	ui5strap.Button.prototype.setLoading = function(loading){
		if(loading){
			this.$().attr('disabled', 'disabled').text(this.getLoadingText());
		}
		else{
			this.rerender();
		}
