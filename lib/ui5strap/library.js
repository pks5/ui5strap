...
(function(){
  ...
  jQuery.sap.declare("ui5strap.Insert");
  ...
  jQuery.sap.declare("ui5strap.Pull");
  ...
  ui5strap.RenderUtils = {
      ...
      renderContent : function(rm, oControl, text){
          var content = oControl.getContent(),
              insertContent = oControl.getInsertContent(),
              text = oControl.getText();
        
          if(insertContent === ui5strap.Insert.After){
          ...
          if(insertContent === ui5strap.Insert.Before){
              rm.writeEscaped(text);
          }
      }
