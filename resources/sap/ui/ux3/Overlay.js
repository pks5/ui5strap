...
sap.ui.ux3.Overlay.prototype._getShell=function(){var s=jQuery(".sapUiUx3Shell").control();if(s.length>0&&!this._oShell){this._oShell=s.length?s[0]:null}return this._oShell};
