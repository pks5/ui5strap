...
sap.ui.commons.ComboBoxRenderer.setEditable=function(c,e){if(c.mobile){var s=c.$("select");if(e&&c.getEnabled()){s.removeAttr("disabled")}else{s.attr("disabled","disabled")}}sap.ui.commons.TextFieldRenderer.setEditable.apply(this,arguments)};
sap.ui.commons.ComboBoxRenderer.setEnabled=function(c,e){if(c.mobile){var s=c.$("select");if(e&&c.getEditable()){s.removeAttr("disabled")}else{s.attr("disabled","disabled")}}sap.ui.commons.TextFieldRenderer.setEnabled.apply(this,arguments)};
