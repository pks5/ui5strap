 ...
 */
jQuery.sap.declare("sap.m.ObjectIdentifier");jQuery.sap.require("sap.m.library");jQuery.sap.require("sap.ui.core.Control");sap.ui.core.Control.extend("sap.m.ObjectIdentifier",{metadata:{library:"sap.m",properties:{"title":{type:"string",group:"Misc",defaultValue:null},"text":{type:"string",group:"Misc",defaultValue:null},"badgeNotes":{type:"boolean",group:"Misc",defaultValue:null,deprecated:true},"badgePeople":{type:"boolean",group:"Misc",defaultValue:null,deprecated:true},"badgeAttachments":{type:"boolean",group:"Misc",defaultValue:null,deprecated:true},"visible":{type:"boolean",group:"Appearance",defaultValue:true}}}});jQuery.sap.require("sap.ui.core.IconPool");
...
sap.m.ObjectIdentifier.prototype.setTitle=function(t){this.setProperty("title",t,true);this.$().find(".sapMObjectIdentifierTitle").text(this.getTitle());return this};
sap.m.ObjectIdentifier.prototype.setText=function(t){this.setProperty("text",t,true);this.$().children(".sapMObjectIdentifierText").text(this.getText());return this};
