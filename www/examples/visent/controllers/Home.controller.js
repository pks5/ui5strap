sap.ui
		.define(
				...
				function(Controller) {
					...
					return Controller
							.extend(
									"net__rozzo__webgl.visent__app.controllers.Home",
									{
										...
										onInit : function() {
											...
											loader
													.load(
															'./examples/visent/models/collada/pump/pump.dae',
															function(collada) {

																model = collada.scene;
																animations = collada.animations;
																kfAnimationsLength = animations.length;
																model.scale.x = model.scale.y = model.scale.z = 0.125; // 1/8
																// scale,
																// modeled
																// in cm
											...
											function init() {
												...
												model.getChildByName(
														'camEye_camera', true).visible = false;
												model.getChildByName(
														'camTarget_camera',
														true).visible = false;
												...
												for (var i = 0; i < kfAnimationsLength; ++i) {
													...
													for (var h = 0, hl = animation.hierarchy.length; h < hl; h++) {
														...
														if (keys.length && sids) {
															...
															animation.data.hierarchy[h].node
																	.updateMatrix();
