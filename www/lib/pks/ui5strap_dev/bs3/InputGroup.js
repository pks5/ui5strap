...
sap.ui.define(['./library', "../core/ControlBase"], function(ui5strapBs3Lib, ControlBase){
	 ...
	 * @constructor
	 * @public
	 * @alias pks.ui5strap.bs3.InputGroup
	 * 
	 */
	var InputGroup = ControlBase.extend("pks.ui5strap.bs3.InputGroup", /** @lends pks.ui5strap.bs3.InputGroup.prototype */ {
		metadata : {
	 ...
	 * @protected
	 */
	InputGroup.prototype._getStyleClassPrefix = function(){
		return "ui5strapInputGroup";
	};
