...
sap.ui.define(['./library', "../core/library", "../core/ControlBase", "../core/Utils", "../core/RenderUtils", "./PositionSupport"], function(ui5strapBs3Lib, ui5strapCoreLib, ControlBase, Utils, RenderUtils, PositionSupport){
	 ...
	 * 
	 */
	var Text = ControlBase.extend("pks.ui5strap.bs3.Text", /** @lends pks.ui5strap.bs3.Text.prototype */ {
		metadata : mMetaData,
	...
	/**
	 * @alias pks.ui5strap.bs3.Text.prototype
	 */
	 ...
	 * @protected
	 */
	TextProto._getStyleClassPrefix = function(){
		return "ui5strapText";
	};
